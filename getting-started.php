...
<div class = "responsive-tabs-notice">
	<h1> <?php _e('Welcome to Responsive Tabs!', 'responsive-tabs' ); ?> </h1> 
 	<?php 	_e( 	'<h4>Overview</h4> <p>All theme options for Responsive Tabs are set Appearance>Customize so you can see dynamically changes to the theme will look.
 			...
 			<h4>Basic Setup</h4>    		  	
 		  	<ol>
 		  	   <li>Go to Appearance>Customize>Site Title & Tagline. Choose a relatively brief site title and tagline (roughly 20 characters each) and a 2-3 character "Site Short Title". 
 		  	   As you narrow the screen width, you will see the tagline disappear and then, at smart phone width, the short title replace the full site title.
 		  	   <li>Add additional branding/identity information in one or both of two ways:
 		  	   <ul><li>Populate the Site Info Splash widget area (appears when a "?" on the header bar is clicked) -- enable this under 
 		  	   Appearance>Customize>Site Info Page ?</li><li>Populate the Front Page Highlight Area -- either by adding a widget ( possible graphics ) to the Highlight Area or 
 		  	   directly enter text for this area in Appearance>Customize>Front Page Highlight.</li></ul></li> 
 		  		<li>Enter the tab titles you want, separated by commas, in Appearance>Customize>Tab Titles, like so: <br />
 	...
 	_e(	'<h4>For more ideas visit <a href="http://responsive-tabs-theme-for-wp.com">the theme home page.</a>', 'responsive-tabs' ); ?>
